...
$pageTitle = 'Data Pengiriman - Fuelman';
...
try {
    $stmt = $pdo->prepare("
        ...
        WHERE fl.status_progress IN ('waiting_fuelman', 'done')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">
                    <i class="bi bi-droplet"></i> Data Pengiriman - Fuelman
                </h4>
            </div>
            <div class="card-body">
                <?php if (isset($error)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                <?php if ($log['status_progress'] == 'waiting_fuelman'): ?>
                                                    <a href="form.php?id=<?php echo $log['id']; ?>" 
                                                       class="btn btn-primary" data-bs-toggle="tooltip" title="Input Data">
                                                        <i class="bi bi-droplet"></i>
                                                    </a>
                                                <?php elseif ($log['fm_created_at']): ?>
                                                    <span class="btn btn-success btn-sm" data-bs-toggle="tooltip" title="Sudah Selesai">
