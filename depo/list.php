...
$pageTitle = 'Data Pengiriman - Pengawas Depo';
...
try {
    $stmt = $pdo->prepare("
        ...
        WHERE fl.status_progress IN ('waiting_depo', 'waiting_fuelman', 'done')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">
                    <i class="bi bi-building"></i> Data Pengiriman - Pengawas Depo
                </h4>
            </div>
            <div class="card-body">
                <?php if (isset($error)): ?>
